...
mod tests {
    ...
    unsafe fn get_node_pool() -> BufferTextureV2<u32> {
        ...
        BufferTextureV2::from_data(data)
    }
    ...
    fn flag_nodes_works() {
        ...
        unsafe {
            ...
            let output = node_pool.data();
            dbg!(&output[..8]);
            assert_eq!(output[..8], [flag_value, 0, 0, 0, 0, 0, 0, 0]);
